      ...
      <div class="container w-[1595px] h-[867px] relative">
        <div class="w-[1595px] h-[867px] relative">
          ...
          <div class="w-[571px] h-[817px] left-[68px] top-[25px] absolute">
            ...
            <div class="w-[600px] left-0 top-[117px] absolute text-black text-[34px] font-bold font-sans leading-[41.48px] tracking-wide">Selamat Datang, Silahkan Daftar untuk lanjut menjadi kemitraan kami</div>
            <div class="w-[571px] h-[90px] left-0 top-[280px] absolute" id="NamaInput">
              <label for="namaInput" class="left-0 top-0 absolute text-neutral-500 text-xl font-medium font-sans leading-normal" @click="focusNamaInput">Nama Pemilik</label>
            ...
            <div class="w-[571px] h-[90px] left-0 top-[390px] absolute" id="EmailNput">
