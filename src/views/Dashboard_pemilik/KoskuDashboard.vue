          ...
          <div class="flex-col gap-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div v-for="product in products" :key="product.id" class="bg-white shadow-md rounded-lg p-4 relative">
                ...
                <img v-if="product.image.length > 0" :src="product.image[0]" alt="Product Image" class="w-full h-32 rounded object-cover mb-4">
...
const placeholderImage = 'path/to/placeholder/image.png'; // Update with actual path
