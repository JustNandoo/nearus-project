            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div v-for="product in products" :key="product.id" class="bg-white shadow-md rounded-lg p-4 relative">
                ...
                <div class="absolute top-2 right-2">
                  ...
                  <!-- Dropdown menu -->
                  <div v-if="dropdownVisible(product.id)" class="absolute right-0 mt-2 w-32 bg-white border border-gray-300 rounded-md shadow-lg">
                    <button @click="deleteProduct(product.id)" class="block w-full text-left px-4 py-2 text-sm text-red-500 hover:bg-gray-100 flex items-center">
