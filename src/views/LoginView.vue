    ...
    <div class="container w-[1595px] h-[867px] relative">
      <div class="w-[1595px] h-[867px] relative">
        ...
        <div class="w-[571px] h-[817px] left-[68px] top-[25px] absolute">
          ...
          <div class="w-[202px] h-[54px] left-[369px] top-[617px] absolute" id="btn-signup">
            <div class="w-[202px] h-[54px] left-0 top-0 absolute rounded-[5px] border-2 border-sky-300" @click="signUp" style="border-width: 4px;"></div>
            <div class="left-[64px] top-[16px] absolute text-black text-lg font-bold font-sans">Sign Up</div>
          </div>
          <div class="w-[266px] h-[54px] left-0 top-[617px] absolute" id="btn-login"> 
            <div class="w-[266px] h-[54px] left-0 top-0 absolute bg-gradient-to-r from-sky-300 to-blue-500 shadow" @click="login"></div>
