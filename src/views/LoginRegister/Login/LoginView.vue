    ...
    <div class="container w-[1595px] h-[867px] relative">
      <div class="w-[1595px] h-[867px] relative">
        ...
        <div class="w-[571px] h-[817px] left-[68px] top-[25px] absolute">
          ...
          <div class="w-[483px] left-0 top-[117px] absolute text-black text-[34px] font-bold font-sans leading-[41.48px] tracking-wide">Selamat Datang Kembali, Silahkan Login Untuk Lanjut</div>
          <form @submit.prevent="handleSubmit">
            <div class="w-[571px] h-[90px] left-0 top-[280px] absolute" id="EmailInput">
              ...
              <input id="emailInput" v-model="email" ref="emailInput" type="email" class="left-[1px] top-[60px] absolute text-black text-opacity-80 text-lg font-semibold font-sans leading-tight outline-none border-b border-black w-[570px]" placeholder="Masukkan Email Anda" />
            </div>
            ...
            <div class="w-[571px] h-[90px] left-0 top-[415px] absolute" id="PasswordInput">
              ...
              <input id="passwordInput" v-model="password" ref="passwordInput" :type="passwordVisible ? 'text' : 'password'" class="left-[1px] top-[60px] absolute text-black text-opacity-80 text-lg font-semibold font-sans leading-tight outline-none border-b border-black w-[570px]" placeholder="Masukkan Kata Sandi Anda" />
              <button type="button" @click="togglePasswordVisibility" class="absolute right-0 top-[70px] transform -translate-y-1/2 mr-2">
            ...
            <button type="submit" class="w-[266px] h-[54px] left-0 top-[617px] absolute transition duration-300 ease-in-out transform hover:scale-105" id="btn-login">
              <span class="w-[266px] h-[54px] left-0 top-0 absolute bg-gradient-to-r from-sky-300 to-blue-500 shadow"></span>
              <span class="w-[49px] h-[0px] left-[197px] top-[3px] absolute origin-top-left rotate-90 border border-white"></span>
