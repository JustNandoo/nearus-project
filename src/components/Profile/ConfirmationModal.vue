      ...
      <div class="relative bg-white rounded-lg shadow-lg max-w-sm w-full p-6">
        <div class="text-center">
          ...
          <button
              type="button"
              @click="$emit('close')"
              class="ml-2 text-gray-600 bg-white border border-gray-300 hover:bg-gray-50 focus:ring-4 focus:outline-none focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5"
          >
            Cancel
          </button>
        </div>
