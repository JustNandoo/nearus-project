<template>
  <div class="bg-white rounded-lg shadow-lg w-[450px] h-[670px] px-5">
      <div class="flex items-center justify-between border-b-[1px] border-black pb-4">
          <img class="mt-5 ml-1 w-[100px] h-[100px] object-cover rounded-full" :src="data.profilepicture" alt="">
        <div class="mt-5 mr-4">
    ...
    <div class="">
      ...
      <div class="w-full bg-gray-100 h-[10px]">
      </div>
      <div class="mt-5 ml-2">
