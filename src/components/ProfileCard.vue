<template>
  <div class="profile-card bg-white rounded-lg shadow-lg w-[450px] h-[670px] px-5 z-[10000]">
...
import profilePicture from '../assets/images/tesimg1.jpeg'; // Updated to use import
</script>
