          ...
          <div class="flex gap-5 max-md:flex-col max-md:gap-0">
            ...
            <div class="flex flex-col ml-5 w-[57%] max-md:ml-0 max-md:w-full">
              <div class="flex flex-col self-stretch px-5 my-auto max-md:mt-10">
                ...
                <div class="mt-4">
                  <div class="flex gap-5 max-md:flex-col max-md:gap-0">
                    <div v-for="(facility, index) in room.facilities" :key="index" class="flex flex-col w-[30%] max-md:w-full justify-start">
                      <div class="flex flex-col text-sm leading-7 text-black whitespace-nowrap">
                        <div v-for="(item, idx) in facility.items" :key="idx" class="flex gap-5 mt-6 first:mt-0 items-center">
