    ...
    <div class="flex gap-5 max-md:flex-col max-md:gap-0">
      ...
      <div class="flex flex-col ml-5 w-[22%] max-md:ml-0 max-md:w-full">
        <div
          ...
          <router-link to="/PaymentReview" class="max-md:px-5 max-md:mt-10">
            <button
              class="justify-center items-center px-24 py-5 ml-12 mt-14 text-base text-center text-white bg-sky-600 rounded-xl shadow-2xl">
              Pilih
            </button>
